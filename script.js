const myMap = new Map([
    ...
    [9, "Was ist das wichtigste bei Schweißausbrüche? Das W."],
    ...
    [14, "Habe die Milch fallen gelassen? Sie war nicht mehr Haltbar."],
    ...
    [20, "Der Löwe schmeißt eine Party und alle Tiere kommen außer welches? Der Elefant weil sie im Kühlschrank ist!"],
    [21, "Ein Kind will über denn von Krokodill bewohnten Fluss welches gefährlich ist. Das Kind schafft es, wieso? Weil die krokodille auf er Party sind."],
    [22, "Das Kind stirbt trotzdem, warum? Weil sie vom Stein Getroffen wurde."],
